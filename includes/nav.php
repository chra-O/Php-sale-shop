...
<nav class="navbar navbar-expand-lg navbar-light bg-white m-2 radius-10 shadow-sm">
  <a class="navbar-brand" href="#"><img src="assets/img/location.svg" width="40"> welcome</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link btn btn-light m-1" href="login.php">log In</a>
      </li>
    <?php  
     if(isset($_SESSION['admin']) || isset($_SESSION['user'])){

    echo'<li class=" show nav-item " >
          <a href="?logout" name="logout"  class="  nav-link btn btn-light m-1"> log Out</a>
          </li>';
     }?>
    </ul>
